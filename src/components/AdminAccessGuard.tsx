...
import { ShieldAlert, ArrowLeft, ShieldCheck, UserCheck } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto px-4 py-16 text-center space-y-6">
      ...
      <div className="p-5 bg-white border border-stone-200 rounded-md max-w-md mx-auto space-y-3 text-left">
        <p className="text-xs font-bold text-stone-900 uppercase tracking-wider">
          Demo Authorization Switch
        </p>
        <p className="text-xs text-stone-500">
          Select an authorized representative identity to access the moderation pipeline:
        </p>
